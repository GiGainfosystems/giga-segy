...
// const TEST_FILE: &str = "test_data/DutchMiniHead.sgy";
...
//     assert_eq!(trace_headers[0].trace_start_byte, 3840);
//     assert_eq!(trace_headers[0].trace_byte_len, 50 * 4);
...
//     assert_eq!(data.len(), trace_headers[0].trace_byte_len);
...
//     assert_eq!(data.len(), trace_headers[2499].trace_byte_len);
//     assert_eq!(data[0], map.map[trace_headers[2499].trace_start_byte]);
//     println!("{:?}", data);
// }
...
//     assert_eq!(
//         data.len(),
//         trace_headers[0].trace_byte_len / bin_header.sample_format_code.datum_byte_length()
//     );
//     // assert_eq!(data[0], map.map[trace_headers[0].trace_start_byte]);
//     println!("{:?}", data);
...
//         assert_eq!(
//             data.len(),
//             h.trace_byte_len / bin_header.sample_format_code.datum_byte_length()
//         );
//     }
// }
...
//         assert_eq!(
//             data.len(),
//             h.trace_byte_len / segy.get_bin_header().sample_format_code.datum_byte_length()
//         );
//     }
// }
...
//         println!("{:?}", data);
//         assert_eq!(data.len(), h.trace_byte_len);
//     }
// }

// #[test]
// fn test_ascii_bytes_to_string() {
//     let bytes = b"I am a great big string.";
//     let string = crate::read_data::ascii_bytes_to_string(bytes).expect("Could not string.");
//     assert_eq!(&string, "I am a great big string.");
// }
...
//     let mut th = segy.traces_iter().nth(0).unwrap().trace_header.clone();
//     th.trace_name = [b'S', b'E', b'G', b'0', b'1', b'2', b'3', b'4'];
//     let string = th
//         .get_trace_name()
//         .expect("Trace name could not be gotten.");
//     assert_eq!(&string, "SEG01234");
// }

// #[test]
// fn test_transduction_units_other() {
//     let x: i16 = 121;
//     let units = crate::enums::TransductionUnits::new(x);
//     assert_eq!(units, crate::enums::TransductionUnits::Invalid);
// }

// #[test]
// fn test_gain_type_other() {
//     let x: u16 = 121;
//     let units = crate::enums::GainType::new(x);
//     assert_eq!(units, crate::enums::GainType::Invalid);
// }
